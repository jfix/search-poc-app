...
export default function Result(props) {
    ...
    var subjectArray = (language === 'English') ? props.document.subjects_en : props.document.subjects_fr;

    const subjects = subjectArray.map(s => {
        return (
            <span style={{ marginRight: "0.3em", fontSize: "0.6em" }} className="badge rounded-pill bg-primary">{s}</span>
        )
    })
        ...
        <div className="card p-0 result mb-12" style={{ "width": "100%", "minWidth": "100%" }}>
            <div className="row">
                <div className="col-md-2">
                    <a href={`/details/${props.document.id}`} rel="noreferrer" target="_blank" title="Click for details">
                ...
                <div className="col-md-10">
                    <div className="card-body">
                        ...
                        <p className="card-text">
                            <a href={props.document.url}>{props.document.url}</a>
                        </p>
                        <div className='row'>
